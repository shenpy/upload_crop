...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/shen.xianpeng/code/upload_crop/cropsqlite3/django.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'tbsa-ngua^poka%)aw&+vqdrj$qsap$o@p0kaotmr^9pkx$19%'
...
CROP_ABS_PATH = os.path.join(MEDIA_ROOT,"crop")
CROP_VIR_PATH = "/static/crop/"
